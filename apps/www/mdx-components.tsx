...
export const mdxComponents = {
  h1: ({ className, ...props }: React.ComponentProps<"h1">) => (
    <h1
      className={cn(
        "text-foreground font-satoshi mt-2 scroll-m-28 text-4xl font-bold tracking-tight sm:text-3xl",
        className
      )}
      {...props}
    />
    ...
    return (
      <h2
        id={props.children
          ...
          .toLowerCase()}
        className={cn(
          "text-foreground font-satoshi mt-8 scroll-m-28 text-2xl font-medium tracking-tight first:mt-0 sm:text-xl lg:mt-8 [&+p]:!mt-4 *:[code]:text-xl",
          className
        )}
        {...props}
      />
  ...
  h3: ({ className, ...props }: React.ComponentProps<"h3">) => (
    <h3
      className={cn(
        "text-foreground font-satoshi mt-8 scroll-m-28 text-xl font-medium tracking-tight sm:text-lg *:[code]:text-xl",
        className
      )}
      {...props}
    />
  ...
  h4: ({ className, ...props }: React.ComponentProps<"h4">) => (
    <h4
      className={cn(
        "text-foreground font-satoshi mt-8 scroll-m-28 text-lg font-medium tracking-tight sm:text-base",
        className
      )}
      {...props}
    />
  ...
  TabsContent: ({
    ...
    <TabsContent
      className={cn(
        "relative [&_h3.font-satoshi]:text-base [&_h3.font-satoshi]:font-medium *:[figure]:first:mt-0 [&>.steps]:mt-6",
        className
      )}
      {...props}
    />
