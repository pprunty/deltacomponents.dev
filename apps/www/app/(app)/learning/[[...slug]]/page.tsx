            ...
            <div className="mx-auto flex w-full max-w-2xl min-w-0 flex-1 flex-col gap-8 px-4 py-6 text-neutral-800 md:px-0 lg:py-8 dark:text-neutral-300">
              <div className="flex flex-col gap-2">
                <div className="flex items-start justify-between">
                  <div></div>
                  <div className="learning-nav bg-background/80 border-border/50 fixed inset-x-0 bottom-0 isolate z-50 flex items-center gap-2 border-t px-6 py-4 backdrop-blur-sm sm:static sm:z-0 sm:border-t-0 sm:bg-transparent sm:px-0 sm:pt-1.5 sm:backdrop-blur-none">
                    <DocsCopyPage
                      page={rawContent}
                      url={absoluteUrl(indexPage.url)}
                    />
                    {neighbours.previous && (
                      <Button
                        variant="secondary"
...
export async function generateStaticParams() {
  return learningSource.generateParams()
}
