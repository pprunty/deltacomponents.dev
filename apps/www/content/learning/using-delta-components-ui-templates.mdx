...
```bash
pnpm dlx shadcn@latest add @delta/voice-chat-template
```
...
```bash
pnpm dlx shadcn@latest add @delta/audio-dashboard-template
```
...
```bash
pnpm dlx shadcn@latest add @delta/agent-conversation-template
```
...
```bash
pnpm dlx shadcn@latest add @delta/[template-name]
```
