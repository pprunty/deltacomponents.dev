...
<ComponentPreview name="chat" height="700px" />
...
```bash
npx shadcn@latest add https://deltacomponents.dev/r/chat
```
...
```bash
npm install lucide-react streamdown motion
```
...
<ComponentPreview name="chat" height="500px" />

### Advanced Demo with Token Streaming
