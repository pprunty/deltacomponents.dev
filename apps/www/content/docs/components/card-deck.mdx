...
<Admonition type="warning" title="Image Aspect Ratios"> For a consistent "deck" feel, all images in the images array should share the same aspect ratio. Mixing portrait and landscape images in a single deck may result in inconsistent layout shifts during swiping. </Admonition>
