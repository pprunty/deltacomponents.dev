...
<ComponentPreview name="card-deck-demo" dependencies={["framer-motion", "swiper", "lucide-react"]} />

## Installation

<Installation name="card-deck" dependencies={["lucide-react", "framer-motion", "swiper"]} />
...
<ComponentPreview name="card-deck-yugioh-demo" dependencies={["framer-motion", "swiper", "lucide-react"]} />

### Balatro Card Deck

Here's an example using Balatro-style card images:

<ComponentPreview name="card-deck-balatro-demo" dependencies={["framer-motion", "swiper", "lucide-react"]} />
