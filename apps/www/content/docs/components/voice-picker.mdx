---
title: Voice Picker
description: Searchable voice selector with audio preview, orb visualization, and voice integration.
featured: true
component: true
---
...
<Installation name="voice-picker" dependencies={["@elevenlabs/elevenlabs-js"]} />
