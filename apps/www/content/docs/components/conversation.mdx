...
<Installation name="conversation" dependencies={["use-stick-to-bottom"]} />
...
- This component is inspired by Vercel's [AI SDK Conversation component](https://ai-sdk.dev/elements/components/conversation) with modifications for Delta Components UI
