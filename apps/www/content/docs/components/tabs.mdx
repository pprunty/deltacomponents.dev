...
Control how tab content appears with customizable entrance animations. The tabs component uses Framer Motion for smooth transitions.
...
Content panels use Framer Motion for smooth entrance animations. By default, content fades in with a subtle y-axis translation when activated.
