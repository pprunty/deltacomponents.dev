    ...
    <Dialog onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-h-[calc(100vh-2rem)] w-full overflow-y-auto sm:max-w-2xl md:max-w-3xl lg:max-w-4xl">
        <DialogHeader className="text-left">
          ...
          <DialogDescription>
            Install the theme in your project using one of the following
            methods.
          </DialogDescription>
        </DialogHeader>
        <div className="min-w-0 space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-2 text-sm">
              ...
              <code className="bg-muted rounded px-1 py-0.5">globals.css</code>{" "}
              or <code className="bg-muted rounded px-1 py-0.5">App.css</code>{" "}
              file, replacing the{" "}
              <code className="bg-muted rounded px-1 py-0.5">:root</code> and{" "}
              <code className="bg-muted rounded px-1 py-0.5">.dark</code>{" "}
              blocks.
            </p>
            <CodeBlock
