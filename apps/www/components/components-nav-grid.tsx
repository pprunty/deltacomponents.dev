...
function NavCard({ href, title, description, variant = "default", className }: NavCardProps) {
  const baseClasses = "flex w-full flex-col items-start rounded-lg transition-colors p-4 text-sm"
