  ...
  return (
    <div className="relative grid h-full flex-1 place-items-center overflow-hidden">
      <div className="z-10 flex flex-col items-center space-y-6">
        <svg
          className="size-16 fill-foreground dark:fill-foreground transition-colors mb-4"
          width="26"
          height="26"
          viewBox="0 0 282 308"
        ...
        <div className="hidden md:flex md:flex-col md:items-center md:space-y-4">
          ...
          <Balancer className="max-w-2xl px-4 text-sm text-center text-muted-foreground md:text-lg">
            Delta Components is a collection of open source reusable React components that are customizable via the shadcn CLI and v0 integration. The components are expertly designed to make the difference in your users&apos; experience.
          </Balancer>
        </div>
        <div className="h-4 md:hidden"></div>
        <div className="flex flex-wrap items-center justify-center gap-4 mt-2 md:mt-6">
          <Link href="/docs/introduction" className={cn(buttonVariants())}>
            Explore the docs
          </Link>
          <Link 
