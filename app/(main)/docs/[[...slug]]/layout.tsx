...
export default function DocsLayout({ children }: DocsLayoutProps) {
  return (
    <div className="container relative">
      ...
      <Float placement="bottom-left" offset={16} position="fixed" onlyMobile>
      ...
      {/* Share Button (still server-side) - positioned to the left of scroll-to-top */}
      <Float placement="bottom-right" offset={{ x: 64, y: 16 }} onlyMobile>
