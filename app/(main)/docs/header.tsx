  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center">
        ...
        {/* Docs tab with contrasting underline */}
        <Link 
          href="/docs/introduction" 
          className="relative flex items-center ml-4 h-12 px-3 font-medium text-sm text-foreground hover:text-primary transition-colors"
        >
          Delta
          <span className="absolute bottom-0 left-1.5 right-1.5 h-0.5 bg-primary" />
        </Link>
      </div>

      {/* Mobile hamburger menu - only visible on mobile */}
      <div className="flex items-center gap-1 shrink-0 lg:hidden mx-[-5px]">
        <Drawer
          open={isOpen}
