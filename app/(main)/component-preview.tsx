  ...
  admonition: (
    <div className="space-y-4 w-[380px]">
      ...
      <Admonition type="info" solid>
        This is an info admonition with solid styling. It provides additional
        information that might be helpful.
      </Admonition>

      {/* Warning admonition (solid) */}
      <Admonition type="warning" title="Custom Warning Title" solid>
        This is a warning admonition with a custom title. It alerts users about
        potential issues.
      </Admonition>

      {/* Danger admonition (solid) */}
      <Admonition type="danger" solid>
        This is a solid danger admonition. It indicates a critical error or
        important warning.
      </Admonition>
    </div>
  ),
...
export function ComponentPreview({
  ...
  useEffect(() => {
    if (containerRef.current && !portalContainer) {
      ...
      container.className =
        'component-portal-container absolute inset-0 flex items-center justify-center';
...
export const componentPreviewData: Record<string, ComponentPreview> = {
  ...
  'neobrutalism-card': {
    ...
    description:
      'A card component with a neobrutalism design style, featuring bold borders and shadows.',
    dependencies: [],
    registryDependencies: [],
  ...
  'smart-form': {
    name: 'Smart Form',
    description:
      'An intelligent form component with built-in validation and error handling.',
    dependencies: [],
    registryDependencies: [],
  ...
  'text-input': {
    name: 'Text Input',
    description:
      'A customizable text input component with various states and styles.',
    dependencies: [],
    registryDependencies: [],
  ...
  'floating-button': {
    ...
    description:
      'A versatile floating button component with customizable position, tooltip support, and responsive behavior.',
    dependencies: ['@phosphor-icons/react'],
    registryDependencies: [],
  ...
  modal: {
    name: 'Modal',
    description:
      'A versatile modal component with customizable overlay, animations, and multiple content layout options.',
  ...
  'share-button': {
    name: 'Share Button',
    description:
      'A versatile share button component with customizable position, tooltip support, and responsive behavior.',
    dependencies: ['@phosphor-icons/react'],
    registryDependencies: [],
  ...
  avatar: {
    name: 'Avatar',
    description:
      'A versatile avatar component that supports images, initials, and fallback content with automatic gradient generation.',
    dependencies: [],
    registryDependencies: [],
  ...
  'product-spotlight-card': {
    ...
    description:
      'A card component for displaying a product spotlight with a product image, title, and description.',
    dependencies: [],
    registryDependencies: [],
  ...
  'social-icons': {
    name: 'Social Icons',
    description:
      'A component for displaying social icons with customizable styles.',
    dependencies: [],
    registryDependencies: [],
