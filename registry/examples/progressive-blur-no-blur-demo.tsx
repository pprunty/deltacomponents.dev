...
export default function ProgressiveBlurNoBlurDemo() {
  return (
    <div
      className="relative flex h-full w-full flex-col items-center justify-center text-foreground"
      style={{ backgroundColor: "hsl(var(--background))" }}
    >
      <ProgressiveBlur position="top" blurEnabled={false} />
      <ProgressiveBlur position="bottom" blurEnabled={false} />
      ...
      <div className="flex h-[calc(100vh-1rem)] w-full flex-col items-center overflow-scroll">
        <div className="mt-42 grid content-start justify-items-center gap-6 text-center">
          <div className="relative max-w-[12ch] text-xs leading-tight opacity-40">
            Scroll down to see the mask effect without blur
          </div>
        </div>
