...
Textarea with character limits and validation for controlled content length. The `lg` size provides adequate space for content approaching the 500-character limit.
