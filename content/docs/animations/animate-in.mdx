---
title: Animate In
description: A simple and lightweight animation component that animates children elements into view with CSS transitions, customizable directions, timing, blur effects, and intersection observer support.
---
...
export function Component() {
  return (
    <AnimateIn direction="up" delay={200} enableBlur={true} blurAmount={10}>
      <h1 className="text-4xl font-bold">Blurred Entrance</h1>
      <p className="text-muted-foreground">
        This content animates with a blur-to-focus effect
      </p>
    </AnimateIn>
  )
}
