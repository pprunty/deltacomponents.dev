...
```bash
npx shadcn@latest add https://deltacomponents.dev/r/floating-object.json
```
...
<ComponentPreview name="floating-object-compass-demo" />

<ComponentPreview name="floating-object-multiple-demo" />
