---
title: Smart Form
description: A comprehensive form component that automatically generates forms from field definitions with built-in Zod validation, multiple input types, and advanced features like field grouping and conditional visibility.
links:
...
The Smart Form component provides a declarative way to build complex forms with minimal boilerplate. It supports multiple input types, automatic validation with Zod schemas, field grouping, conditional visibility, and customizable layouts.
