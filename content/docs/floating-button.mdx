...
A versatile floating button component with customizable position, tooltip support, and responsive behavior. Perfect for primary actions like creating new items or navigating back to top. Can also be used as a container to position any element in fixed or absolute positions.
  ...
  <table className="w-full">
    ...
    <tbody>
      <tr className="m-0 border-t p-0 even:bg-muted">
        ...
        <td className="border px-4 py-2 text-left">Optional icon component to render inside the button</td>
      </tr>
      <tr className="m-0 border-t p-0 even:bg-muted">
        <td className="border px-4 py-2 text-left">`children`</td>
        <td className="border px-4 py-2 text-left">`React.ReactNode`</td>
        <td className="border px-4 py-2 text-left">-</td>
        <td className="border px-4 py-2 text-left">Optional children elements to render inside the button</td>
      </tr>
      <tr className="m-0 border-t p-0 even:bg-muted">
      ...
      <tr className="m-0 border-t p-0 even:bg-muted">
        <td className="border px-4 py-2 text-left">`onlyDesktop`</td>
        <td className="border px-4 py-2 text-left">`boolean`</td>
        <td className="border px-4 py-2 text-left">`false`</td>
        <td className="border px-4 py-2 text-left">Whether to show the button only on desktop screens</td>
      </tr>
      <tr className="m-0 border-t p-0 even:bg-muted">
        <td className="border px-4 py-2 text-left">`onlyMobile`</td>
        <td className="border px-4 py-2 text-left">`boolean`</td>
        <td className="border px-4 py-2 text-left">`false`</td>
        <td className="border px-4 py-2 text-left">Whether to show the button only on mobile screens</td>
      </tr>
      <tr className="m-0 border-t p-0 even:bg-muted">
        <td className="border px-4 py-2 text-left">`opaqueOnScroll`</td>
        <td className="border px-4 py-2 text-left">`boolean`</td>
        <td className="border px-4 py-2 text-left">`false`</td>
        <td className="border px-4 py-2 text-left">Whether to reduce opacity when scrolling down the page</td>
      </tr>
    </tbody>
  </table>
</div>
...
### Floating Button with Custom Children
...
export default function ResponsiveVisibilityExample() {
  return (
    <>
      <FloatingButton.FloatingButton
        icon={Plus}
...
export default function ResponsivePositionExample() {
  return (
    <FloatingButton.FloatingButton
      icon={Plus}
      text="Add Item"
