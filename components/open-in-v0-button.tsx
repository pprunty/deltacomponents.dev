...
export function OpenInV0Button({ url }: { url: string }) {
  ...
  return (
    <Button
      ...
      variant="outline"
      className="h-8 gap-1 rounded-[6px] px-3 text-xs z-[995] font-medium transition-transform duration-150 ease-in-out active:scale-[0.98] bg-card active:bg-gray-100"
      asChild
    >
