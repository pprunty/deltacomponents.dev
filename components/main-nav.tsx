...
export function MainNav() {
  return (
    <div className="mr-4 hidden md:flex items-center">
      ...
      <Link href="/docs/introduction" className="mr-6 lg:mr-6">
        <div className="relative h-full flex items-center pb-[1px]">
          <span className="font-semibold text-md">Delta</span>
          <div className="absolute bottom-[-15px] left-0 w-full h-[2px] bg-primary"></div>
        </div>
      </Link>
    </div>
  )
