...
const Card = ({ className, ...props }: CardProps) => (
  <div className={cn("rounded-xl border bg-background text-card-foreground", className)} {...props} />
)
...
export function ComponentPreviewCard({ 
  ...
  // Create the link URL
  const linkUrl = useDocsLink ? `/docs/${category}/${name}` : `/${category}/${name}`
  ...
  return (
    <Link href={linkUrl} className="block transition-all hover:border-primary/50">
