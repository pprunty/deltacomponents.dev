          ...
          {displayTitle && (
            <h3
              className={cn(
                ...
                solid ? style.solidText : style.title,
              )}
            >
              {displayTitle}
            </h3>
