...
// Hardcoded URLs for each platform
...
export function SocialIcon({ platform, className = '' }: SocialIconProps) {
  const iconProps = {
    className: `
      ...
      ${className || 'w-6 h-6 sm:w-6 sm:h-6 text-muted-foreground hover:text-foreground'}
    `,
    fill: 'currentColor',
...
interface SocialIconsProps {
  ...
  urlMapping?: Record<SocialPlatform, string>;
}
...
export function SocialIcons({
  ...
  containerClassName,
  linkClassName,
  urlMapping: customUrlMapping = urlMapping,
}: SocialIconsProps) {
  return (
    <div className={containerClassName}>
      {platforms.map((platform) => (
        <Link
          key={platform}
          href={customUrlMapping[platform]}
