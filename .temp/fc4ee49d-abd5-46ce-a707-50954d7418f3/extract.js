...
export const hooks: Registry = [
  ...
  },
  {
    ...
    type: "registry:hook",
    registryDependencies: ["https://deltacomponents.dev/r/use-unmount"],
...
`;
    ...
    const isolatedCode = `
      const hooks = ${jsContent.split('=')[1]};
      fs.writeFileSync(path.join(process.cwd(), 'result.json'), JSON.stringify(hooks));
    `;
